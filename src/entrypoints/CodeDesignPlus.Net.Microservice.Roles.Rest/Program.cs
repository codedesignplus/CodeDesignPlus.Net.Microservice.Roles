...
builder.Services.AddRabbitMQ<CodeDesignPlus.Net.Microservice.Roles.Domain.Startup>(builder.Configuration);
builder.Services.AddServiceBus<CodeDesignPlus.Net.Microservice.Roles.Domain.Startup>(builder.Configuration);
builder.Services.AddMapster();
builder.Services.AddFluentValidation();
builder.Services.AddMediatR<CodeDesignPlus.Net.Microservice.Roles.Application.Startup>();
